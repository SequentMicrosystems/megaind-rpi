...
This is the python library to control the [ Industrial Automation Card for Raspberry Pi.](https://sequentmicrosystems.com/index.php?route=product/product&path=33&product_id=52) 
